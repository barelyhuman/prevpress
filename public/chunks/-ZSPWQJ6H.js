...
function Hero() {
  return /* @__PURE__ */ u("section", { class: "p-2 md:p-20 flex flex-col items-center justify-center gap-4 min-h-[80vh] w-full", children: [
    /* @__PURE__ */ u("h2", { class: "text-2xl font-semibold", children: "Simple Content First websites with Preact" }),
    /* @__PURE__ */ u("div", { class: "flex gap-4 items-center", children: /* @__PURE__ */ u(
      "a",
      {
        href: "/",
